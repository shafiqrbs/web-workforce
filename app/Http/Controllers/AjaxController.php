...
class AjaxController extends Controller
{
    ...
    public function filterLangCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => 'Select City'] + $cities, $city_id, array('id' => 'city_id', 'class' => ''));
        echo $dd;
    }
    ...
    public function filterStates(Request $request)
    {
        ...
        $new_state_id = $request->input('new_state_id', 'state_id');
        $states = DataArrayHelper::langStatesArray($country_id);
        $dd = Form::select('state_id[]', ['' => __('Select Province')] + $states, $state_id, array('id' => $new_state_id, 'class' => ''));
        echo $dd;
    }
    ...
    public function filterCities(Request $request)
    {
        ...
        $dd = Form::select('city_id[]', ['' => 'Select City'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'city_id'));
        echo $dd;
    }
