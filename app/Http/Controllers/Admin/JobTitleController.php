...
class JobTitleController extends Controller
{
    ...
    {
        $jobTitles = JobTitle::select(['job_titles.id', 'job_titles.job_title', 'job_titles.is_active', 'job_titles.lang', 'job_titles.is_default', 'job_titles.created_at', 'job_titles.updated_at'])->orderBy('job_title', 'ASC');
