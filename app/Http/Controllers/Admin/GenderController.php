...
class GenderController extends Controller
{
    ...
    public function fetchGendersData(Request $request)
    {
        ...
        $genders = Gender::select([\Illuminate\Support\Facades\DB::raw('@rownum  := @rownum  + 1 AS rownum'),'genders.id', 'genders.gender', 'genders.is_active', 'genders.is_default', 'genders.created_at', 'genders.updated_at']);
        return Datatables::of($genders)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li>
						<a href="javascript:void(0);" onClick="' . $activeHref . '" id="onclickActive' . $genders->id . '"><i class="fa fa-check-square" aria-hidden="true"></i>' . $activeTxt . '</a>
						</li>					
						<li>
							<a href="javascript:void(0);" onclick="deleteGender(' . $genders->id . ', ' . $genders->is_default . ');" class=""><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
						</li>
