...
/* * ******** UserController ************ */
Route::get('edit-profile', 'UserController@myProfile')->name('my.profile');
//Route::put('my-profile', 'UserController@updateMyProfile')->name('my.profile');
Route::put('update-my-profile/{id}', 'UserController@updateMyProfile')->name('update.my.profile');
//Route::get('view-public-profile/{id}', 'UserController@viewPublicProfile')->name('view.public.profile');
Route::get('profile-summary', 'UserController@viewPublicProfile')->name('view.public.profile');
...
Route::get('user/profile/image/delete/{id}', 'UserController@deleteProfileImage')->name('delete.profile.image');
...
Route::get('email/preference', 'UserController@emailPreferences')->name('email.preference');
Route::get('email/preference/save', 'UserController@emailPreferencesSave')->name('email.preference.save');
