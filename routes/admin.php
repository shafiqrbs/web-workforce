...
use Illuminate\Support\Facades\Session;
    ...
    include_once($real_path . 'jury.php');
    include_once($real_path . 'arms.php');
    include_once($real_path . 'gender.php');
    include_once($real_path . 'hear-about-us.php');
    ...
    include_once($real_path . 'payment_history.php');
    include_once($real_path . 'club.php');
    include_once($real_path . 'event.php');
    include_once($real_path . 'archive.php');
    include_once($real_path . 'banner.php');
    include_once($real_path . 'committee_member.php');
    include_once($real_path . 'member.php');
    include_once($real_path . 'news_and_notice_category.php');
    include_once($real_path . 'news_and_notice.php');
    include_once($real_path . 'financial_partner.php');
    include_once($real_path . 'profession.php');
    include_once($real_path . 'event_type.php');
