			...
			<div class="tab-content" id="jobsby">				
                ...
                <div class="srchint">
                    <ul class="row catelist">
                        ...
                        <li class="col-md-4 col-sm-6"><a href="" title="{{$functionalArea->functional_area}}">{{$functionalArea->functional_area}} <span>({{$functional_area_id_num_jobs->num_jobs}})</span></a>
