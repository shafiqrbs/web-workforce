        ...
        <ul class="howlist row">
            ...
            <li class="col-md-6 col-sm-6">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://dl.dropboxusercontent.com/s/wjnsi5nh6668dpy/Explainer%20Video_Final_1080p_HD.mp4?dl=0" allowfullscreen></iframe>
                </div>
            </li>
