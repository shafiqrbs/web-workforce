<div class="header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-12 col-12"> <a href="{{url('/')}}" class="logo"><img src="{{ asset('/') }}images/logo.png" height="70px"  alt="{{ $siteSetting->site_name }}" /></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a href="{{route('aboutus')}}" class="nav-link">{{__('About Us')}}</a> </li>
                            <li class="nav-item"><a href="{{route('whyus')}}" class="nav-link">{{__('Why Us')}}</a> </li>
                            <li class="nav-item"><a href="{{route('pricing')}}" class="nav-link">{{__('Pricing')}}</a> </li>
