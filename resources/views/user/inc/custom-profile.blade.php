        ...
        <div class="jobseeker-inner">
            ...
            <div class="jobseeker-form">
                <div class="form-items">
                    <form id="editForm" name="user_edit_form" method="POST" action="{{ route('update.my.profile') }}" enctype="multipart/form-data" >
                        {{ csrf_field() }}
                            ...
                            <div class="single-input{{ $errors->has('experience') ? ' has-error' : '' }}">
                                ...
                                <select name="experience" required="required">
                                    ...
                                    @foreach($jobExperiences as $jobExperience)
                                        <option value="{{ $jobExperience->id }}" {{ $user->jobExperience && $user->jobExperience->id ==  $jobExperience->id ? 'selected' : ''}}>{{ $jobExperience->job_experience }}</option>
                                    @endforeach
                                </select>
