        ...
        <div class="auto-container">
            <div class="event-list-content">
                ...
                <div class="schedule-inner">
                    <h2 style="font-size: 15px;border-bottom: 1px solid;padding-bottom: 5px;font-weight: bold;">{{$partnerDetails->total()}} {{__('messages.Results_Records_in_Archives')}} </h2>
                ...
                @foreach($partnerDetails as $partner)
                        ...
                        <div class="schedule-block-three">
                            <div class="inner-box" style="padding: 0px">
                                <div class="inner view-model" data-toggle="modal" data-target="#exampleModalCenter" archive-id="{{$partner->id}}" data-href="{{route('get_archive_multiple_attachment')}}" style="min-height: 122px">
                                    <div class="schedule-date" style="top: 15px;left: 15px;">
                                        <ul class="list clearfix" style="padding-bottom: 3px;cursor: pointer">
                                            <li><b><i class="fas fa-cloud-download"></i>&nbsp;<u style="color: red">{{'Download General Informations'}}<br>{{' and Results'}}</u></b></li>
                                                <li><i class="flaticon-clock-circular-outline"></i>{{date_format($partner->created_at,'d-F-Y').' '.date('h:i A', strtotime($partner->created_at))}}</li>
                                        </ul>
                                    </div>
            ...
            <div class="pagination-wrapper centred">
                {{ $partnerDetails->links('includes.pagination-view') }}
            </div>
        </div>
    </section>
    <!-- events-list end -->
