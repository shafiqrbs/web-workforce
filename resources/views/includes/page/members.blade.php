...
<section class="team-section sec-pad bg-color-1" id="member">
    ...
    <div class="auto-container">
        <div class="sec-title">
            <h6><br><br></h6> <h2>MEET OUR CHAMPION </h2>
            <div class="title-shape"></div>
            <a href="index.html" class="theme-btn">All Champions</a>
        </div>
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-one wow fadeInUp animated animated animated" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInUp;">
                    <div class="inner-box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-one wow fadeInUp animated animated animated" data-wow-delay="400ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 400ms; animation-name: fadeInUp;">
                    <div class="inner-box">
