            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Manage Members</span> </div>
                        <div class="actions">
...
<script>
    ...
    function delete_committee_member(id) {
        if (confirm('Are you sure! you want to delete?')) {
            $.post("{{ route('delete_member') }}", {id: id, _method: 'DELETE', _token: '{{ csrf_token() }}'})
    ...
    function make_not_active(id) {
        ...
        $.post("{{ route('make_inactive_member') }}", {id: id, _method: 'PUT', _token: '{{ csrf_token() }}'})
            .done(function (response) {
    ...
    function make_active(id) {
        ...
        $.post("{{ route('make_active_member') }}", {id: id, _method: 'PUT', _token: '{{ csrf_token() }}'})
            .done(function (response) {
                if (response.status == 'ok')
                {
