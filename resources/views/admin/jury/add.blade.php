                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">{{__('messages.Judges_Jury_form')}}</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <ul class="nav nav-tabs">
                            <li class="active"> <a href="#Details" data-toggle="tab" aria-expanded="false"> {{__('messages.Judges_Jury')}} </a> </li>
                        </ul>
                        {!! Form::open(array('method' => 'post', 'route' => 'store_jury', 'class' => 'form', 'files'=>true)) !!}
