...
<div class="form-body">        
    {!! Form::hidden('id', null) !!}
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}" id="lang_div" style="display: none;">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div" style="display: none;">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'default_cv_count') !!}">
        {!! Form::label('default_cv_count', 'Default Cv Count', ['class' => 'bold']) !!}
        {!! Form::text('default_cv_count', null, array('class'=>'form-control', 'id'=>'default_cv_count', 'placeholder'=>'Cv Count', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'default_cv_count') !!}
    </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
        ...
        <span id="default_state_dd">
            {!! Form::select('state_id', ['' => 'Select Default Province'], null, array('class'=>'form-control', 'id'=>'state_id')) !!}
        </span>
