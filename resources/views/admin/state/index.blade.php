...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Provinces <small>Provinces</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Provinces</span> </div>
                        <div class="actions"> <a href="{{ route('create.state') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add New Province</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="stateDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="state" id="state" autocomplete="off" placeholder="Province"></td>
