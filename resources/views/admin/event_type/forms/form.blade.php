...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'event_type') !!}"> {!! Form::label('Event Type', 'Event Type', ['class' => 'bold']) !!}
        {!! Form::text('event_type', null, array('class'=>'form-control', 'id'=>'event_type', 'placeholder'=>'Event Type', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'event_type') !!}
    </div>
