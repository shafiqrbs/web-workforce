...
@else
{!! Form::open(array('method' => 'post', 'route' => 'store_athlete_user', 'class' => 'form', 'files'=>true)) !!}
@endif
<div class="form-body">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 big-column " style="padding-right: 25px !important;">
                <div class="form-group athelete-mg-0">
                    ...
                    {!! Form::text('athlete_name','', array('class'=>'form-control athlete-field-height','required'=>'true','placeholder'=>'Athlete Name')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::number('age','', array('class'=>'form-control athlete-field-height', 'placeholder'=>'Age')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('mobile','', array('class'=>'form-control athlete-field-height', 'id'=>'mobile', 'placeholder'=>'Mobile')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('height','', array('class'=>'athlete-field-height form-control', 'id'=>'height', 'placeholder'=>'Height')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('father_name','', array('class'=>'athlete-field-height form-control', 'placeholder'=>'Father Name')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('hometown','', array('class'=>'ignore athlete-field-height form-control', 'id'=>'hometown', 'placeholder'=>'Hometown')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('higher_education','', array('class'=>'athlete-field-height form-control', 'id'=>'higher_education', 'placeholder'=>'Higher Education')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                ...
                <div class="form-group athelete-mg-0 athlete-mg-top">
                    ...
                    <div class="radio-list">
                        ...
                        $is_active_2 = '';
                        /*if (old('is_present', ((isset($slider)) ? $slider->is_active : 1)) == 0) {
                            $is_active_1 = '';
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 big-column " style="padding-left: 25px !important;">
                ...
                <div class="form-group athelete-mg-0 athlete-mg-top">
                    ...
                    {!! Form::text('email','', array('class'=>'athlete-field-height form-control','required'=>'true','placeholder'=>'Email')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('place_of_birth','', array('class'=>'form-control athlete-field-height', 'id'=>'place_of_birth', 'placeholder'=>'Place of Birth')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('weight','', array('class'=>'athlete-field-height form-control', 'id'=>'weight', 'placeholder'=>'Weight')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('hobbies','', array('class'=>'athlete-field-height form-control', 'id'=>'hobbies','placeholder'=>'Hobbies')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('mother_name','', array('class'=>'athlete-field-height form-control', 'id'=>'mother_name', 'placeholder'=>'Mother Name')) !!}
                ...
                <div class="form-group athelete-mg-0 athlete-mg-top">
                    ...
                    {!! Form::text('event','', array('class'=>'athlete-field-height form-control', 'id'=>'event','required'=>'true','placeholder'=>'Event')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('address','', array('class'=>'athlete-field-height form-control', 'id'=>'address', 'placeholder'=>'Address')) !!}
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 big-column " style="padding-right: 25px !important;">
                ...
                <div class="form-group athelete-mg-0 athlete-mg-top">
                    ...
                    {!! Form::text('start_of_competition','', array('class'=>'athlete-field-height form-control', 'id'=>'start_of_competition','required'=>'true','placeholder'=>'Start of Competition')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('practicing_shooter_sign','', array('class'=>'athlete-field-height form-control', 'id'=>'practicing_shooter_sign','placeholder'=>'Practicing Shooter Sine')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('name_of_national_coach','', array('class'=>'athlete-field-height form-control', 'id'=>'name_of_national_coach', 'placeholder'=>'Name of National Coach')) !!}
                    {!! APFrmErrHelp::showErrors($errors, 'name_of_national_coach') !!}
                </div>

                <div class="form-group athelete-mg-0 athlete-mg-top">
                    <label class="athlete-label-14">Handedness</label>
                    {!! Form::text('handedness','', array('class'=>'athlete-field-height form-control', 'id'=>'handedness','placeholder'=>'Handedness')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('parent_full_name','', array('class'=>'athlete-field-height form-control', 'id'=>'parent_full_name', 'placeholder'=>'Parent Name')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('parent_mobile','', array('class'=>'athlete-field-height form-control', 'id'=>'parent_mobile', 'placeholder'=>'Parent Phone Number')) !!}
...
{{--                    <span class="color-red font-size-12">*</span>--}}
                    {!! Form::text('relationship','', array('class'=>'athlete-field-height form-control', 'id'=>'relationship', 'placeholder'=>'Relationship')) !!}
                    {!! APFrmErrHelp::showErrors($errors, 'relationship') !!}
                </div>

                <div class="form-group athelete-mg-0 athlete-mg-top">
                    <label class="athlete-label-14">Parent Address</label>
                    {!! Form::text('parent_address','', array('class'=>'athlete-field-height form-control', 'id'=>'parent_address','placeholder'=>'Parent Address')) !!}
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 big-column athlete-section-shadow" style="margin-top: 30px !important;">
        ...
        <table class="table table-responsive table-condensed" id="competitionTable">
            <thead>
