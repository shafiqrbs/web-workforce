...
<div class="form-body">
    @if(isset($executiveMember)&&$executiveMember->profile_image)
        <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            @php
                $subCommitteeGroup= isset($executiveMember)&&array_key_exists($executiveMember->sub_committee_group,$subCommitteeGroups)?$executiveMember->sub_committee_group:'';
            @endphp
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'sub_committee_group') !!}">
                {!! Form::label('sub_committee_group', 'Sub Committee', ['class' => 'bold']) !!} <span class="red">*</span>
                {!! Form::select('sub_committee_group', ['' => 'Select Sub Committee']+$subCommitteeGroups, $subCommitteeGroup, array('class'=>'form-control', 'id'=>'sub_committee_group', 'required'=>'required')) !!}
                {!! APFrmErrHelp::showErrors($errors, 'sub_committee_group') !!}
            </div>
        </div>
    </div>
    <div class="row">
