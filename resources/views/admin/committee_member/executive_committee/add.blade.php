                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="active"> <a href="#Details" data-toggle="tab" aria-expanded="false"> Executive Committee </a> </li>
                        </ul>
                        {!! Form::open(array('method' => 'post', 'route' => 'store.executive.committee.member', 'class' => 'form', 'files'=>true)) !!}
