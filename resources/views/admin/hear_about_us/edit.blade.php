    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.genders') }}">Hear About us</a> <i class="fa fa-circle"></i> </li>
                <li> <span>Edit Hear About us</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->        
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        {!! Form::model($gender, array('method' => 'put', 'route' => array('update.hearUs', $gender->id), 'class' => 'form', 'files'=>true)) !!}
