<li class="nav-item {{ Request::is('admin/news-notice/list')?'open':''}}{{ Request::is('admin/list-news-notice-category')?'open':''}}{{ Request::is('admin/news-notice/create')?'open':''}}{{ Request::is('admin/news-notice/edit/*')?'open':''}}{{ Request::is('admin/sort-news')?'open':''}}">
    <a href="javascript:;" class="nav-link nav-toggle">
        ...
        <span class="title">News & Blog</span> <span class="arrow {{ Request::is('admin/list-news-notice-category')?'open':''}}{{ Request::is('admin/news-notice/list')?'open':''}}{{ Request::is('admin/news-notice/create')?'open':''}}{{ Request::is('admin/news-notice/edit/*')?'open':''}}{{ Request::is('admin/sort-news')?'open':''}}"></span> </a>
