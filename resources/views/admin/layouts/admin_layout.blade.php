    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-header navbar navbar-fixed-top"> 
            ...
            <div class="page-header-inner "> 
                ...
                <div class="page-logo">
                    <a title="{{ $siteSetting->site_name }}" href="{{ route('admin.home') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" height="45px"  alt="{{ $siteSetting->site_name }}" />
                    </a>
        ...
        <div class="page-footer">
            ...
            <div class="page-footer-inner"> {{ date('Y')}} © {{ $siteSetting->site_name }} </div>

            <div class="scroll-to-top" style="opacity: 3.6;margin-bottom: 30px !important;"> <i class="icon-arrow-up"></i> </div>
