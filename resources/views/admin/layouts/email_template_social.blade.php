...
<span style="margin-right:3px;"> <a href="{{ $siteSetting->facebook_address }}">
        <i class="fab fa-facebook-f"></i>
{{--        <img src="{{ asset('/') }}admin_assets/images/small_social_icons/if_facebook_278425.png" alt="Facebook">--}}
    </a> </span>
@endif
