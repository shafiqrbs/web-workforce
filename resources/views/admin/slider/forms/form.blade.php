...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_image') !!}">
        @if(isset($slider))
        {!! Form::label('slider_image', 'Slider Image', ['class' => 'bold']) !!}  <span style="font-size: 10px">( Greater than or equal to width 1920px & height 832px. )</span>
        @else
            {!! Form::label('slider_image', 'Slider Image', ['class' => 'bold']) !!} <span class="red">*</span> <span style="font-size: 10px">( Greater than or equal to width 1920px & height 832px. )</span>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_heading') !!}">
        {!! Form::label('slider_heading', 'Slider heading', ['class' => 'bold']) !!} <span class="red">*</span>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_description') !!}">
        {!! Form::label('slider_description', 'Slider description', ['class' => 'bold']) !!} <span class="red">*</span>
        {!! Form::textarea('slider_description', null, array('class'=>'form-control', 'id'=>'', 'placeholder'=>'Slider description', 'dir'=>$direction,'rows'=>'3')) !!}
