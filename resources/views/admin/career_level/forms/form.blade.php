...
<div class="form-body">
    ...
    @php
        $committeeType= isset($careerLevel)&&array_key_exists($careerLevel->committee_type,$committeeTypes)?$careerLevel->committee_type:'';
    @endphp
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'committee_type') !!}">
        {!! Form::label('committee_type', 'Committee Type', ['class' => 'bold']) !!}
        {!! Form::select('committee_type', $committeeTypes, $committeeType, array('class'=>'form-control', 'id'=>'committee_type')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'committee_type') !!}
    </div>
