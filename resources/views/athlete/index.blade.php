                        ...
                        <div class="col-md-3">
                            <div class="explore-block-two margin-bottom-50">
                                <div class="inner-box text-center">
                                    ...
                                    <div class="content-box">
                                        <h4 class="text-center">{{$value['athlete_name']}}</h4>
                                    </div>
                                    <a href="{{route('athlete_details',$value['id'])}}">
                                        <div class="overlay-content">
                                            <div class="icon-box">{{ ImgUploader::print_image("athlete_profile/thumb/$img") }}</div>
                                            <div class="text">
                                                <h4 class="text-center">                {{$value['athlete_name']}}<br>{{$value['athlete_type']}}
                                                </h4>
                                            </div>
                                        </div>
                                    </a>
