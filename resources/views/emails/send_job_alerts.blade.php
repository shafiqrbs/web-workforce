        ...
        <td class="cols-wrapper" style="padding-left:12px;padding-right:12px"><!--[if mso]>
         <table border="0" width="576" cellpadding="0" cellspacing="0" style="width: 576px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tbody><tr>
                <td>    
                <a href="{{route('job.detail', $job->slug)}}" style="text-decoration:none;font:bold 16px/20px HelveticaNeue,Helvetica,Arial,sans-serif;color:#00c;padding:0 0 5px"  data-saferedirecturl="https://www.google.com/url?q={{route('job.detail', $job->slug)}}">{{$job->title}}</a>
