    ...
    <tr>
        <td class="content-wrapper" style="padding-left:24px;padding-right:24px"><br>
            <div class="title" style="font-family: Helvetica, Arial, sans-serif; font-size: 18px;font-weight:400;color: #000;text-align: left;
                 padding-top: 20px;">Dear {{$details['name']}} ,</div></td>
    </tr>
    <tr>
                    ...
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    <p style="color: black">Athlete has been registered successfully on "{{ $siteSetting->site_name }}".Please login your account & complete your information.</p>
                                    <p style="color: black">
                                        Email : {{$details['userData']->email}}
                                    </p>
                                    <p style="color: black">
                                        Athlete ID : {{$details['athleteId']}}
                                    </p>
                                    <p style="color: black">
                                        Password : {{$details['password']}}
                                    </p>
                                    <p style="color: black">Please store password carefully & don't share with others</p>
                                    <br>
                                    <span style="color: #fff;text-decoration: none;background: #e3e3e3; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"><a href="{{ route('login') }}"><u>Login Link</u></a></span>
