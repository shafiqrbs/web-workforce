                                        ...
                                        @else
                                            <div class="show-profile">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="profile-info" style="padding-bottom: 10px;">
                                                        <h4>{{ $savedJobseekerPofile->user_name }}</h4>
                                                            @if($savedJobseekerPofile->user_email)
                                                                <p style="margin-bottom: 0rem;"><i class="fa fa-envelope"></i> {{$savedJobseekerPofile->user_email}}</p>
                                                            @endif
                                                        <h5 style="padding: 15px; text-align: center">This profile is no longer available !</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
