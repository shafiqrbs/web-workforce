                    ...
                    <div class="jobseeker-inner">
                        ...
                        <div class="jobseeker-form">
                            <div class="form-items">
                                <form name="user_form" id="theform" class="form-horizontal" method="POST" action="{{ route('employer_register') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-step step-one">
                                        ...
                                        <div class="single-input{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input type="email" name="email" required="required" placeholder="{{__('Email')}}" value="{{old('email')}}">
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="single-input{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="phone" placeholder="{{__('Telephone Number')}}" value="{{old('phone')}}">
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="form-step step-two">
                                        ...
                                        <div class="single-input full-width {{ $errors->has('custom_job_title') ? ' has-error' : '' }}">
                                            <label for="custom_job_title">Job Title *</label>
                                            <input type="text" name="custom_job_title" value="{{ old('custom_job_title') }}">
                                        </div>
                                    ...
                                    <div class="form-step step-three">
                                        ...
                                        <div class="single-input{{ $errors->has('company_name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="company_name" required="required" placeholder="{{__('Company or Business Name')}}" value="{{old('company_name')}}">
                                        ...
                                        <div class="single-input{{ $errors->has('industry') ? ' has-error' : '' }}">
                                            ...
                                            <select name="industry" required="required">
                                                ...
                                                @foreach($industry as $industrys)
                                                    <option value="{{ $industrys->id }}" {{ old('industry') == $industrys->id ? 'selected' : '' }}>{{ $industrys->industry }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="single-input full-width{{ $errors->has('type_of_business') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="type_of_business" required="required" placeholder="{{__('Type of Business')}}" value="{{old('business_years')}}">
                                        ...
                                        <div class="single-input{{ $errors->has('business_years') ? ' has-error' : '' }}">
                                            ...
                                            <input type="number" name="business_years" required="required" placeholder="{{__('Years in Business')}}" value="{{old('business_years')}}">
                                            @if ($errors->has('business_years'))
                                                <span class="help-block custom-help-block"> <strong>{{ $errors->first('business_years') }}</strong> </span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="single-input{{ $errors->has('number_employees') ? ' has-error' : '' }}">
                                            ...
                                            <input type="number" name="number_employees"  min="1" placeholder="{{__('Number of Employees')}}" value="{{old('number_employees')}}">
                                        </div>
                                        ...
                                        <div class="single-input{{ $errors->has('street_address') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="street_address" placeholder="{{__('Street Address')}}" value="{{old('street_address')}}">
                                        ...
                                        <div class="single-input{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="postal_code" required="required" placeholder="{{__('Postal Code')}}" value="{{old('postal_code')}}">
                                        ...
                                        <div class="single-input" style="margin:0px; padding:0px;">
                                           {{-- <input type="text" name="social_name" placeholder="{{__('Please Add')}}" value="{{old('social_name')}}">--}}
                                        </div>

                                        <div class="single-input hearAboutUs" id="Others" style="display:none;">
                                            <input type="text" name="social_name" placeholder="{{__('Please Add')}}" value="{{old('social_name')}}">
                                        </div>
                                            ...
                                            <div class="select2Dropdown">
                                                <select name="job_title[]" id="job_title" class="job_title select2" required="required"  multiple>
                                                    ...
                                                    @foreach($jobTitles as $jobTitle)
                                                        <option value="{{ $jobTitle->id }}" {{in_array($jobTitle->id, old("job_title") ?: []) ? "selected": ""}}>{{ $jobTitle->job_title }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        {{--<div class="single-input{{ $errors->has('other_languages') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="other_languages" placeholder="{{__('Other Languages')}}" value="{{old('other_languages')}}">
                                                ...
                                                <div class="row pt-2 pb-2">
                                                    ...
                                                    <div class="col-md-6 text-right" style="text-align:right; float:right">
                                                        <div class="form-check form-check-inline" style="display:inline;">
                                                            <input class="form-check-input" type="radio" name="is_third_party_hiring" id="iainlineRadio1" required="required" value="1" {{ old('is_third_party_hiring')  ==1 ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="iainlineRadio1">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-inline" style="display:inline;">
                                                            <input class="form-check-input" type="radio" name="is_third_party_hiring" id="iainlineRadio2" required="required" value="0" {{ old('is_third_party_hiring') == 1  ? 'checked' : '' }}>
                ...
                form3.validate({
                    ...
                    messages: { // custom messages for radio buttons and checkboxes
                        ...
                        password_confirmation: {
                            ...
                            equalTo: 'Password Confirmation must be same as "Password"',
