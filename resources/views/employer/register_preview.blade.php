                        ...
                        <div class="jobseeker-form">
                            <div class="usercoverName" style="padding: 20px; color: white">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <h6>   {{((bool)$user->is_third_party_hiring)? 'Third Party Hiring':'Not Third Party Hiring'}}</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <a href="{{ route('employer_register_edit', ['id'=> $user->id]) }}"><button class="btn btn-info  btn-sm"><b>Edit</b></button></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">{{ $user->industry?$user->industry->industry:''}}</div>
                            ...
                            <form id="register_confirm" class="form-horizontal" method="POST" action="{{ route('employer_register_confirm', $user->id) }}">
                                {{ csrf_field() }}
                                <div class="row">
