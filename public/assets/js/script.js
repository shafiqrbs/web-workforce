(function($) {
	...
	if ($('.banner-carousel').length) {
		...
		$('.banner-carousel > div').on('click', function () {
			$('.banner-carousel').trigger('stop.owl.autoplay');
			var carousel = $('.banner-carousel').data('owl.carousel');

			var isStop = document.getElementsByClassName('slider-stop');
			if (isStop.length > 0) {
				$('body').removeClass('slider-stop');
				carousel.settings.autoplay = true;
				carousel.options.autoplay = true;
			}else{
				$('body').addClass('slider-stop');
